      ...
      <section className='grid gap-8 border-b border-border/70 py-12 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)]'>
        ...
        <div className='grid gap-3'>
          {apiHighlights.map((item) => (
            <div
              key={item}
              className='flex items-center gap-4 rounded-2xl border border-border/70 bg-card/80 px-5 py-4 shadow-sm'
            >
              <div className='h-2.5 w-2.5 shrink-0 rounded-full bg-(--color-accent-strong)' />
